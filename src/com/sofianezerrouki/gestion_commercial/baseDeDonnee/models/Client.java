package com.sofianezerrouki.gestion_commercial.baseDeDonnee.models;
...
public class Client {
    ...
    public Client(String societe, String civilite, String nomClient, String prenom, String adresse, String codePostal, String ville, String pays, String telephone, String mobile, String fax, String email, int type, boolean livreMemeAdresse, boolean factureMemeAdresse, boolean exemptTva, String saisiPar, Date saisiLe, String auteurModif, Date dateModif, String observations) {
        this.societe = societe;
        this.civilite = civilite;
        this.nomClient = nomClient;
        this.prenom = prenom;
